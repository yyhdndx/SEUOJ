...
type ForumTopic struct {
	...
	AuthorID    uint64     `gorm:"column:author_id;not null;index:idx_forum_topics_author_id" json:"author_id"`
	ReplyCount  int        `gorm:"column:reply_count;not null;default:0" json:"reply_count"`
	IsPinned    bool       `gorm:"column:is_pinned;not null;default:false;index:idx_forum_topics_pinned" json:"is_pinned"`
	IsLocked    bool       `gorm:"column:is_locked;not null;default:false" json:"is_locked"`
	LastReplyAt *time.Time `gorm:"column:last_reply_at;index:idx_forum_topics_last_reply_at" json:"last_reply_at"`
